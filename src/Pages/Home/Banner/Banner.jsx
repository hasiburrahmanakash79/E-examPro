    ...
    >
      <div id="slide1" className="relative w-full carousel-item">
        ...
        <div className="absolute flex flex-col items-center justify-center w-full h-full bg-gradient-to-r from-black to-purple-950 opacity-60">
          <h4 className="mb-2 md:mb-6 text-2xl md:text-3xl text-white text-center">
            Get Ready For The Battle Of Examination
          </h4>
          <h4 className="md:mb-6 text-lg md:text-xl text-white">
            with
          </h4>
          
          <h1 className="md:mb-10 font-semibold text-white text-5xl  md:text-7xl">E-ExamPro</h1>

          <button className="mt-2 md:mt-8 text-lg font-bold rounded-full btn btn-warning">
            Try Demo Exam!
          </button>
        </div>
